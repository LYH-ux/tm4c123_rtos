...
#ifndef _MICRO_LAB_H_
#define _MICRO_LAB_H_

#include <rtthread.h>

#define SEND_MSG_SIZE       30
#define RECV_MSG_SIZE       30

#define MICRO_LIB_HEAD                0x5a58
#define MICRO_LIB_VERSION             0x10
#define MICRO_LIB_ORGANIZATION        0x0000
#define MICRO_LIB_SECTION             0x0000
#define MICRO_LIB_DATAPOINT           0x0000
...
extern void micro_lib_update_canvas(COMPONENT_TYPE component_type,
                             rt_uint16_t component_num,
                             rt_uint8_t *msg,
                             rt_uint16_t msg_len);

extern void micro_lib_update_OSC(char *data, unsigned short len);
